          ...
          <div key={index} className="xs:mt-16 mt-5 font-inter z-50 ">
            <div className="bg-gradient-to-br from-indigo-300/20 to-purple-300/10 border-solid border-2 border-violet-400/30 rounded-xl backdrop-blur-md mxs:p-5 p-2 xs:w-[384px] xs:h-[460px] mxs:w-[300px] mxs:h-[380px] w-full h-full">
              <div className="flex justify-between">
                <div>
                  <h3>Current bid</h3>
                  <div className="flex items-center gap-1 text-lightBlue font-medium hover:cursor-pointer">
                    <p> {item.price}</p>
                  </div>
                </div>
                <div>
              ...
              <div className="hover:cursor-pointer mt-3 xs:w-[345px] xs:h-[290px] mxs:w-[265px] mxs:h-[210px] xxs:w-[215px] xxs:h-[160px] w-[180px] h-[120px] rounded-md overflow-hidden">
              ...
              <div className="mt-4">
                ...
                <div className="flex mt-2 items-center gap-3 text-sm text-slate-400 hover:cursor-pointer">
                  <img
                    src={item.userImage}
                    alt="userimg"
                    width="24px"

...
const Hero = () => {
  return (
    <div>
      <h3 className="text-[80px] font-clash font-[600] leading-[5rem] mt-24">
        Super NFT
        <br />
      ...
      <div className="flex gap-2 mt-3 text-xs">
        <p className="rounded-full border border-dimWhite px-3 py-1">Sports</p>
        <p className="rounded-full border border-dimWhite px-3 py-1">Cartoon</p>
        <p className="rounded-full border border-dimWhite px-3 py-1">
          Virtual World
        </p>
        <p className="rounded-full border border-dimWhite px-3 py-1">Classic</p>
      </div>
    </div>
  );
};
